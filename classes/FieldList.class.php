<?php
/**
 * Class to manage adminlist fields for the Classifieds plugin.
 * Taken from the glFusion 2.0 dev code, this class can be removed
 * when the plugin requires glFusion 2.0+.
 *
 * @author      Mark R. Evans   mark AT glfusion DOT org
 * @copyright   Copyright (c) 2021 Mark R. Evans   mark AT glfusion DOT org
 * @package     classifieds
 * @version     v1.4.0
